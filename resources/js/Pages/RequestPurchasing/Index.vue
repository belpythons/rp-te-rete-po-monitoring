...
<template>
    <AuthenticatedLayout title="Request Purchasing (RP)">
        <!-- Single Focus Metric Card -->
        <section class="mb-8">
            <div class="max-w-xs rounded-xl p-5 text-white bg-blue-600 shadow-md flex flex-col justify-between h-28">
        ...
        <section class="bg-white rounded-2xl shadow-lg overflow-hidden mb-8">
            <div class="p-6 border-b border-slate-100 flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 bg-slate-50">
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="text-lg font-bold text-slate-900">Data Monitoring Request Purchasing</h3>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-3 w-full lg:w-auto">
                    ...
                    <div class="flex items-center gap-2">
                        <a 
                            :href="`/report/export/excel?phase=RP` + (activeMonth ? `&month_year=${activeMonth}` : '')" 
                        ...
                        <a 
                            :href="`/report/export/pdf?phase=RP` + (activeMonth ? `&month_year=${activeMonth}` : '')" 
            ...
            <div v-if="showEditModal" class="fixed inset-0 bg-slate-900/60 backdrop-blur-[2px] z-50 flex items-center justify-center p-4">
                <div class="bg-white rounded-2xl border border-slate-100 w-full max-w-[800px] max-h-[90vh] overflow-hidden shadow-2xl flex flex-col relative">
                    <div class="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                        <h3 class="text-lg font-bold text-slate-800">Edit Data Request Purchasing</h3>
