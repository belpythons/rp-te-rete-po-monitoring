                    ...
                    <form @submit.prevent="submitUpdate" class="p-6 overflow-y-auto space-y-6 flex-grow text-left">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" v-model="editForm.re_te" class="w-full h-10 px-3 rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm bg-white" />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" v-model="editForm.delivery" class="w-full h-10 px-3 rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm bg-white" />
                            </div>
